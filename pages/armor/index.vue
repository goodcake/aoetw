    ...
    <div class="row padtop">
      ...
      <div class="col-md-12">
        <div class="n1">
          ...
          <strong>這篇條目包含防禦類型、近防與遠防</strong>
        </div>
        <h3>防禦類型</h3>
        <div class="hrn1"></div>
        <div class="n1">
          ...
          <p>
            每個防禦類型都有一個裝甲值，大多數的單位來看，這個裝甲值都是0，只是說明這個單位在這個防禦類型中，並會受到額外的傷害，但在某些單位中，他並非是0。而是一個數字表示，他可以額外抵抗這類防禦類型的傷害，而如果是負數，則代表會增加更多傷害。例如<nuxt-link
              to="/units/Cataphract"
              >聖騎兵</nuxt-link
          ...
          <div class="row">
            <div class="col-md-4">
              ...
              <ul>
                ...
                <li>
                  <nuxt-link to="/armor/Armor_Class_War_Elephant"
                    >戰象</nuxt-link
                  >
                </li>
              </ul>
          ...
          <div class="n1">
            ...
            <div class="row">
              <div class="col-md-6">
                <ul>
                  <li>
                    所有<nuxt-link to="/building/Barracks">軍營</nuxt-link>單位
                  </li>
                  <li>
                    所有<nuxt-link to="/building/Stable">馬廄</nuxt-link>單位
                  </li>
                  <li>
                    除了<nuxt-link to="/units/Siege_Tower">攻城塔</nuxt-link
                    >之外的所有<nuxt-link to="/building/Siege_Workshop"
                      >攻城武器製造所</nuxt-link
                    >單位
                  </li>
                  <li>
          ...
          <div class="n1">
            ...
            <div class="row">
              <div class="col-md-6">
                <ul>
                  <li>
                    所有<nuxt-link to="/building">建築</nuxt-link
                    >都是造成遠防傷害。
                  </li>
                  <li>
                    所有<nuxt-link to="/building/Archery_Range"
                      >射箭場</nuxt-link
                    >單位
                  </li>
                  <li>
            ...
            <div class="hrn1"></div>
            <div class="n1">
              下列的<nuxt-link to="/techs">科技</nuxt-link
              >都可以增加「近防/遠防」
              <h3>
              ...
              <h3><nuxt-link to="/techs/untech">城堡特殊科技</nuxt-link></h3>
              <div class="hrn1"></div>
